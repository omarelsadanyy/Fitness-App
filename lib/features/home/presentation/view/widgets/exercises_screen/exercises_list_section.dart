    ...
    return Expanded(
      child: BlocBuilder<ExercisesCubit, ExercisesStates>(
        builder: (context, state) {
          ...
          if (exercisesState.isLoading) return const SkeletonLoadingExercises();

          if (exercisesState.isFailure) {
            return  Center(
              child: Text(context.loc.errorLoadingExercises, style:const TextStyle(color: Colors.red)),
            );
          }
          ...
          if (exercises.isEmpty) {
            return  Center(
              child: Text(context.loc.noExercises, style: const TextStyle(color: Colors.white)),
            );
          }
