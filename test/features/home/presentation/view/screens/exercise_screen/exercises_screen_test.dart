...
void main() {
  ...
  const MoverMuscleEntity fakeMuscle = MoverMuscleEntity(
    id: "1",
    name: "Chest",
  ...
  Widget prepareWidget({required MoverMuscleEntity muscle}) {
    return SizeProvider(
  ...
  testWidgets('renders empty SizedBox when primMoverMuscle is null', (tester) async {
    await mockNetworkImagesFor(() async {
      await tester.pumpWidget(
        prepareWidget(muscle: const MoverMuscleEntity(id: '', name: '', image: '')),
      );
      await tester.pump();
