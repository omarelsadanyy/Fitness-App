...
import 'package:fitness/features/auth/presentation/views/widgets/forget_pass/create_new_pass_section.dart';
 ...
 setUpAll(() {
  ...
  testWidgets('test create password screen structure ...', (
   ...
   getIt.get<ForgetPassCubit>();
    ...
    expect(find.byType(Logo), findsOneWidget);
    expect(find.byType(CreateNewPassSection), findsOneWidget);
    expect(find.text(l10n.makeSure8Char), findsOneWidget);
    expect(find.text(l10n.createNewPass), findsOneWidget);
